...
num_fake_records = 1000000  # Change this value based on your needs
...
try:
    add_all_elapsed_time = time.time() - start_time
    print(f"Add all time elapsed: { add_all_elapsed_time} seconds")
    session.add_all(fake_records)
    session.commit()
